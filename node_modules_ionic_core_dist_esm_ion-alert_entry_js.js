...
/* harmony import */ var _ionic_global_a049bcbf_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./ionic-global-a049bcbf.js */ 58420);
/* harmony import */ var _button_active_767ae7c7_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./button-active-767ae7c7.js */ 71821);
/* harmony import */ var _overlays_963ffac5_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./overlays-963ffac5.js */ 9266);
...
let Alert = class {
  constructor(hostRef) {
    ...
    this.animated = true;
    this.onBackdropTap = () => {
      this.dismiss(undefined, _overlays_963ffac5_js__WEBPACK_IMPORTED_MODULE_3__.B);
    };
    this.dispatchCancelHandler = (ev) => {
      const role = ev.detail.role;
      if ((0,_overlays_963ffac5_js__WEBPACK_IMPORTED_MODULE_3__.i)(role)) {
  ...
  connectedCallback() {
    (0,_overlays_963ffac5_js__WEBPACK_IMPORTED_MODULE_3__.e)(this.el);
  }
  componentWillLoad() {
    this.inputsChanged();
    this.buttonsChanged();
   ...
   */
  present() {
    return (0,_overlays_963ffac5_js__WEBPACK_IMPORTED_MODULE_3__.d)(this, 'alertEnter', iosEnterAnimation, mdEnterAnimation);
  }
  /**
   ...
   */
  dismiss(data, role) {
    return (0,_overlays_963ffac5_js__WEBPACK_IMPORTED_MODULE_3__.f)(this, data, role, 'alertLeave', iosLeaveAnimation, mdLeaveAnimation);
  }
  /**
   * Returns a promise that resolves when the alert did dismiss.
   */
  onDidDismiss() {
    return (0,_overlays_963ffac5_js__WEBPACK_IMPORTED_MODULE_3__.g)(this.el, 'ionAlertDidDismiss');
  }
  /**
   * Returns a promise that resolves when the alert will dismiss.
   */
  onWillDismiss() {
    return (0,_overlays_963ffac5_js__WEBPACK_IMPORTED_MODULE_3__.g)(this.el, 'ionAlertWillDismiss');
  }
  rbClick(selectedInput) {
    ...
    (0,_overlays_963ffac5_js__WEBPACK_IMPORTED_MODULE_3__.s)(selectedInput.handler, selectedInput);
  ...
  callButtonHandler(button, data) {
    if (button && button.handler) {
      ...
      const returnData = (0,_overlays_963ffac5_js__WEBPACK_IMPORTED_MODULE_3__.s)(button.handler, data);
      if (returnData === false) {
