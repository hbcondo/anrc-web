...
let PickerColumnInternal = class {
  ...
  componentWillLoad() {
    const visibleCallback = entries => {
      ...
      if (ev.isIntersecting) {
         ...
         */
        const oldActive = (0,_helpers_6ff04165_js__WEBPACK_IMPORTED_MODULE_3__.g)(this.el).querySelector(`.${PICKER_COL_ACTIVE}`);
  ...
  get activeItem() {
    return (0,_helpers_6ff04165_js__WEBPACK_IMPORTED_MODULE_3__.g)(this.el).querySelector(`.picker-item[data-value="${this.value}"]`);
  }
